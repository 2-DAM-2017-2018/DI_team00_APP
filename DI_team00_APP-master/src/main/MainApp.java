...
public class MainApp extends Application {
    ...
    public MainApp() {
        claseData.add(new Clase("Aula 1", "15/01/2018", "Pedro"));
        claseData.add(new Clase("Aula 1", "16/01/2018", "Antonio"));
        claseData.add(new Clase("Aula 1", "02/01/2018", "Pepe"));
        claseData.add(new Clase("Aula 1", "13/01/2018", "Rafa"));
        claseData.add(new Clase("Aula 1", "20/01/2018", "Mario"));
        claseData.add(new Clase("Aula 1", "29/01/2018", "Dani"));
